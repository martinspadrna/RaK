...
importScripts('./rak-release-metadata.js?sw=1.7.87');
...
const SW_RELEASE_CACHE_MARKER = 'v1.7.87';
...
const RAK_RELEASE_170_POLICY = 'display-1.7;technical-1.7.87;cache-v1.7.87;startup-auth-restore-only;about-production-stability-backup;complete-backup-preserved';
const RAK_170_STARTUP_AUTH_HOTFIX_ASSETS = ['./core.js?v=1.7.87', './app-admin-unlock.js?v=1.7.87', './app-menu-pages.js?v=1.7.87'];
const RAK_170_SHIFT_REPORT_HOTFIX_ASSETS = ['./rak-shift-report.js?v=1.7.87'];
const RAK_170_REPORT_APPEARANCE_ASSETS = ['./app.js?v=1.7.87', './appearance-theme.js?v=1.7.87', './rak-shift-report.js?v=1.7.87'];
const RAK_170_GENERATOR_STAFFING_ASSETS = ['./admin-rotation-generator.js?v=1.7.87', './admin-rotation.js?v=1.7.87', './rotation-tasks.js?v=1.7.87'];
...
const SAME_VERSION_HOTFIX_ASSETS = ['./app-menu-pages.js?v=1.7.87'];
const DEVELOPMENT_EXPORT_HOTFIX_ASSETS = ['./export.js?v=1.7.87', './rak-lazy-external-libs.js?v=1.7.87'];
const DEVELOPMENT_COMPLETE_BACKUP_HOTFIX_ASSETS = ['./app.js?v=1.7.87', './app-menu-admin-renderer.js?v=1.7.87', './rak-complete-backup.js?v=1.7.87'];
// Development-only invalidace starých admin/Supabase assetů po oddělení test DB.
const DEVELOPMENT_ADMIN_HOTFIX_ASSETS = [
  './app.js?v=1.7.87',
  './supabase-config.js?v=1.7.87',
  './supabase-bridge.js?v=1.7.87',
  './app-rotation-sync.js?v=1.7.87',
  './app-admin-unlock.js?v=1.7.87',
  './app-menu.js?v=1.7.87',
  './app-menu-shift-report.js?v=1.7.87',
  './app-home-boot.js?v=1.7.87',
  './kalirna-daymod-override.js?v=20260912-1',
  './kalirna-stats-override.js?v=20260913-1',
  './rotation-tasks.js?v=1.7.87'
];
...
const WARM_START = [
  ...
  './assets/dashboard-icons/vyplata.png',
  './supabase-config.js?v=1.7.87',
  './rak-user-profile.js?v=1.7.87',
  './rak-auth-gate.js?v=1.7.87',
  './rak-account-access.js?v=1.7.87',
  './rak-login-splash.js?v=1.7.87',
  './rak-login-fix.js?v=1.7.87',
  './rak-login-life.js?v=1.7.87',
  './core.js?v=1.7.87',
  './lifecycle.js?v=1.7.87',
  './app-runtime-guards.js?v=1.7.87',
  './qr.js?v=1.7.87',
  './payroll.js?v=1.7.87',
  './dashboard.js?v=1.7.87',
  './appearance-theme.js?v=1.7.87',
  './ui.js?v=1.7.87',
  './app-navigation.js?v=1.7.87',
  './app-bottom-nav.js?v=1.7.87',
  './app-actions.js?v=1.7.87',
  './app-pwa-connectivity.js?v=1.7.87',
  './app-home-boot.js?v=1.7.87',
  './rak-runtime-stability.js?v=1.7.87',
  './rak-mobile-layout-guard.js?v=1.7.87',
  './rak-feature-routing.js?v=1.7.87',
  './stats.js?v=1.7.87',
  './rotation-name-index.js?v=1.7.87',
  './rotace.js?v=1.7.87',
  './rotation-tasks.js?v=1.7.87',
  './admin-daymods.js?v=1.7.87',
  './app-rotation-controls.js?v=1.7.87',
  './supabase-bridge.js?v=1.7.87',
  './app-rotation-sync.js?v=1.7.87'
];
...
const OFFLINE_REQUIRED = Object.freeze([
  './supabase-vendor-2.110.7.js',
  './app.js?v=1.7.87','./data.js','./module-readiness.js','./rak-namespace.js','./rak-dom-security-hardening.js',
  './core.js?v=1.7.87','./lifecycle.js?v=1.7.87','./app-runtime-guards.js?v=1.7.87','./ui.js?v=1.7.87',
  './app-navigation.js?v=1.7.87','./app-bottom-nav.js?v=1.7.87','./app-actions.js?v=1.7.87',
  './app-pwa-connectivity.js?v=1.7.87','./app-home-boot.js?v=1.7.87','./rak-runtime-stability.js?v=1.7.87',
  './rak-mobile-layout-guard.js?v=1.7.87','./rak-feature-routing.js?v=1.7.87','./stats.js?v=1.7.87',
  './rotation-name-index.js?v=1.7.87','./rotace.js?v=1.7.87','./rotation-tasks.js?v=1.7.87','./admin-daymods.js?v=1.7.87',
  './app-rotation-controls.js?v=1.7.87','./supabase-config.js?v=1.7.87','./supabase-bridge.js?v=1.7.87',
  './app-rotation-sync.js?v=1.7.87',
