...
- Poslední čistě dokumentační ověření: [Actions #262](https://github.com/martinspadrna/RaK/actions/runs/35981493016), SUCCESS; release-preview správně nevytvořil deployment.
...
Dne 24. 9. 2026 vlastník uvedl, že produkční převod „vypadá ok“. Jde o užitečné pozorování, ale **není to úplné potvrzení předepsaného fyzického iPhone checklistu pro 1.7.83 ani souhlas s fází B**. Fáze B, která uzavírá legacy veřejné čtecí cesty, zůstává neprovedená a vyžaduje nový výslovný souhlas po doložené přejímce.
