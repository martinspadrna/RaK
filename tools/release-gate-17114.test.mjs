...
test('1.7.114 stacked action-button milestone remains active in successors',()=>{
...
test('1.7.114 historical gate remains wired after successor releases',()=>{
  ...
  assert(read('CHANGELOG.md').includes('## RaK 1.7.114 (development)'));
});
