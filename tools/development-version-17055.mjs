...
const recovery=[
  ...
  "      '12. Ověř počet a obsah všech 19 exportovaných tabulek, 12 soukromých importů podle skutečné zálohy, cizí klíče, role owner/admin/deputy a přihlášení z nových zařízení. Teprve pak nasaď aplikaci a proveď critical runtime + security smoke.',",
...
change(backup,previous,recovery,'restore dependency ordering');
change(backup,
