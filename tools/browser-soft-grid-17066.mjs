...
assert(['v1.7.66-softgrid-draftguard1','v1.7.67-equalgrid-reload1','v1.7.68-async-draft-guard1','v1.7.69-local-drafts1','v1.7.70-canonical-source1','v1.7.71-offline-rotation1']
  .some(id=>releaseBuild.includes(id)),'built soft-grid release required');
const isEqualGrid=['v1.7.67-equalgrid-reload1','v1.7.68-async-draft-guard1','v1.7.69-local-drafts1','v1.7.70-canonical-source1','v1.7.71-offline-rotation1']
