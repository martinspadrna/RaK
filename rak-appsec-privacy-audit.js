...
(function setupRakAppSecPrivacyAudit() {
  ...
  const CSP_REPORT_ONLY_PLAN = {
    ...
    sriCandidates: [
      ...
      { id: 'supabase-js', source: 'supabase-vendor-2.110.7.js', current: 'self-hosted exact 2.110.7 with build-time SHA-384 verification', safestNextStep: 'držet přesný pin, hash a offline precache gate; otestovat realtime a reconnect bez reloadu' },
