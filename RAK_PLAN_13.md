...
**Aktuální uživatelská závada:** fyzický iPhone znovu potvrdil problém i po úplném vyčištění dat Edge: RaK online zobrazí aktuální Rotaci, ale po zavření a spuštění bez sítě Rotace není spolehlivě dostupná. Následná diagnostika ukázala dvě architektonické mezery: online cesta neověřovala zpětným čtením, že se snapshot skutečně uložil, a offline start automaticky preferoval localStorage před CacheStorage bez porovnání revize/stáří. Release 1.7.79 proto zavádí společnou vrstvu persistence s fingerprintem, revizí a savedAt, po online zápisu ověřuje obě trvalé kopie, při offline startu porovnává oba kandidáty a novější důvěryhodný stav bezpečně opraví do druhého úložiště. Cache zápis nevytváří žádné položky synchronizační fronty. Přidána je sanitizovaná diagnostika local/durable/revize/stáří/počtu kopií a stav fronty bez obsahu rozpisu. Chromium regresní test ověřuje dvě shodné kopie, záměrně vytvoří starší localStorage proti novější CacheStorage a vyžaduje správnou offline arbitráž i opravu canonical kopie. **P2.3 zůstává na 25 %, dokud stejný scénář neprojde na fyzickém iPhonu; implementace sama se za opravu nepovažuje.**
