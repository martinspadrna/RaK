...
| P1.3 | Build, testy a verze | ČÁSTEČNĚ | Gate 1.7.39–1.7.42 obsahuje kontrolu značek/databáze, unit testy a v GitHub Actions dva kompletní build průchody; 1.7.41 je na Vercelu READY. Zbývá nezávislý iPhone smoke, ověření nového ZIPu a plná reprodukovatelnost na Vercelu. |
...
**Bilance: 0/13** bodů plně uzavřeno. Změny P0.2, P1.3, P1.5 a P2.3 v 1.7.40–1.7.42 jsou dílčí; soukromá záloha `importMeta` neřeší veřejně čitelné absence.
